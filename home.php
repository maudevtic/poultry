...
<body >
    ...
    <div class ="center">
        <div class ="columns" >
            ...
            <div class="hov">
                <p><a href="reports.php"><img src="assets/images/reports.png" alt="Cinque Terre"  width="50px" height="50px"></a></p>
    ...
    <div class="center">
        <div class="columns">
            ...
            <div class="hov">
               <p>
                   <a href=""><img src="assets/images/vs.png" alt="Cinque Terre" width="50px" height="50px"></a>
                </p>
    ...
    <div class="center">
        <div class="columns">
            <div class="hov">
               <p>
                   <a href="employees.php"><img src="assets/images/employee.png" alt="Cinque" Terre width="50px" height="50px"></a>
                </p>
                <a href="employees.php">Employees</a>
            </div>  
            <div class="hov">
               <p><a href="suppliers.php"><img src="assets/images/supplier.png" alt="Cinque Terre" width="50px" height="50px"></a></p>
