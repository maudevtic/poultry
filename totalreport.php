...
<body>
    <div class="bg">
        ...
        <div class="center">
            <div class="columns">
                <span><h2>Total Reports | Logged as: <?php echo ucwords($username); ?></h2></span>
            </div>
        </div>
        <div class="center">
            <div class="columns">
                ...
                <a href="dwmreport.php">
                    <div class="hov">
                        <!-- <p><img src="assets/images/bird.png" alt="Cinque Terre" width="50px" height="50px"></p> -->
                        <a href="dwmreport.php" title="Cost per bird"><h3>DAILY, WEEKLY, MONTHLY REPORT</h3></a>
                    </div>
                </a>
            </div>
        </div>
        <div class="center">
            <div class="columns">
                <a href="combinedreport.php">
                    <div class="hov">
                        <!-- <p><img src="assets/images/bird.png" alt="Cinque Terre" width="50px" height="50px"></p> -->
                        <a href="combinedreport.php"><h3>COMBINED REPORT</h3></a>
                    </div>
                </a>
